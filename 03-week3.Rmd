...
Let's go and have fun **[WINK WINK]**.
...
At this point, you should be able to set your RStudio Server, upload data to it and set the directory etc., ff you struggle with setting up your working directory and you need a reminder, [have a look at how we set this up in our first week](https://uclpg-msc-sgds.github.io/POLS0008/understanding-data.html#understanding-data)!
