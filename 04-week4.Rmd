...
Welcome to your fourth week of **Introduction to Quantitative Research Methods**. This week we will introduce you to sourcing and preparing data from official sources. For the tutorial we will apply what we have learnt over the past weeks onto a new **secondary** data set. 

The practical material that you need to work through in preparation for Thursday's seminar, and a seminar task that you need to do in preparation for Thursday's seminar.

OK... one final push to wrap the basic stuff covered today and previous weeks - [**LET'S DO THIS!**](https://www.youtube.com/watch?v=0aMhmo9fHps)
...
knitr::include_graphics('/Volumes/Anwar-HHD/POLS0008/Computer Lab Notes/images/general/04_ons_web2.png')
```
...
```{r 04-mid-year-download, echo=FALSE, fig.align='center', fig.cap='The `Mid-2020: SAPE23DT4` file that we downloaded.'}
knitr::include_graphics('/Volumes/Anwar-HHD/POLS0008/Computer Lab Notes/images/general/04_download3.png')
```
...
knitr::include_graphics('/Volumes/Anwar-HHD/POLS0008/Computer Lab Notes/images/general/04_load_tidyverse.png')
```
